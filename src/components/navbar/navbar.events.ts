...
export function initNavbar(): void {
  ...
  document
    .getElementById('mobile-nav-profile')
  ...
  document
    ...
    ?.addEventListener('click', () => runSearch('navbar-search'));
  document
    .getElementById('mobile-search-btn')
    ?.addEventListener('click', () => runSearch('mobile-navbar-search'));
  ...
  document
    ...
    ?.addEventListener('click', () => renderRoute('/login'));
  document
    .getElementById('mobile-nav-login')
    ?.addEventListener('click', () => renderRoute('/login'));
}
